...
-- [[ 2. HÀM THÔNG BÁO CYBER NOTIFY VVIP ]]
local function SendCyberNotify(titleText, descText, duration, isSuccess)
    task.spawn(function()
        ...
        Card.Size = UDim2.new(0, 310, 0, 75)
        Card.Position = UDim2.new(1, 10, 0.75, 0)
        Card.BackgroundColor3 = Color3.fromRGB(12, 10, 24)
        ...
        TweenService:Create(Card, TweenInfo.new(0.45, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
            Position = UDim2.new(1, -325, 0.75, 0)
        }):Play()
...
local function LoadMainScript()
    ...
    ToggleButton.Position = DefaultPosToggle; ToggleButton.Size = UDim2.new(0, 64, 0, 64)
    ...
    MainFrame.Position = DefaultPosMainFrame; MainFrame.Size = UDim2.new(0, 365, 0, 480)
    ...
    TitleFrame.Size = UDim2.new(1, 0, 0, 68); TitleFrame.BackgroundTransparency = 1

    local Title = Instance.new("TextLabel", TitleFrame)
    Title.Size = UDim2.new(1, 0, 0.65, 0); Title.BackgroundTransparency = 1
    Title.Text = "★ MRGHOST VVIP ★ [ TTTT ]"; Title.TextColor3 = Color3.fromRGB(233, 213, 255); Title.TextSize = 19.5; Title.Font = Enum.Font.FredokaOne
    ...
    SubTitle.Text = "━━━━ 💎 ULTRA POWERED BY TTTT 💎 ━━━━"; SubTitle.TextColor3 = Color3.fromRGB(192, 132, 252); SubTitle.TextSize = 11.5; SubTitle.Font = Enum.Font.FredokaOne

    local Scroll = Instance.new("ScrollingFrame", MainFrame)
    Scroll.Size = UDim2.new(1, -28, 1, -85); Scroll.Position = UDim2.new(0, 14, 0, 72)
    ...
    AddButton("Xóa Sương Mù (No Fog)", "NoFog", "🌫️❌", function(state)
        Lighting.FogEnd = state and 999999 or 1000
    end)
...
if IsKeyValid() then
    ...
    KeyFrame.Position = UDim2.new(0.5, -175, 0.5, -155)
    ...
    KeyTitle.Text = "🔑 KEY SYSTEM - TTTT VVIP"
    ...
    DiscordBtn.TextSize = 12.5
    Instance.new("UICorner", DiscordBtn).CornerRadius = UDim.new(0, 10)

    DiscordBtn.MouseButton1Click:Connect(function()
        if setclipboard then
            setclipboard(DISCORD_LINK)
            SendCyberNotify("ĐÃ COPY LINK! 🔗", "Đã sao chép link Discord!", 3, true)
        end
    end)
    ...
    GgBtn.MouseButton1Click:Connect(function()
        if setclipboard then
            ...
            SendCyberNotify("ĐÃ COPY LINK! 🔗", "Đã sao chép link Google!", 3, true)
        end
    end)
    ...
    KeyBox.PlaceholderText = "Nhập Key VIP tại đây..."
    KeyBox.Text = ""
    KeyBox.TextColor3 = Color3.fromRGB(255, 255, 255)
    KeyBox.Font = Enum.Font.FredokaOne
    KeyBox.TextSize = 13.5
    ...
    PasteBtn.BackgroundColor3 = Color3.fromRGB(234, 179, 8)
    PasteBtn.Text = "📋 DÁN KEY TỪ KHAY NHỚ TẠM"
    PasteBtn.TextColor3 = Color3.fromRGB(20, 20, 20)
    PasteBtn.Font = Enum.Font.FredokaOne
    PasteBtn.TextSize = 12.5
    Instance.new("UICorner", PasteBtn).CornerRadius = UDim.new(0, 9)

    PasteBtn.MouseButton1Click:Connect(function()
        if getclipboard then
            local clipText = getclipboard():gsub("%s+", "")
            KeyBox.Text = clipText
            SendCyberNotify("ĐÃ DÁN KEY! 📋", "Đã dán Key từ khay nhớ!", 2, true)
        end
    end)
